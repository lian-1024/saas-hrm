      ...
      >
        <FormItem :label="t('employee.detail.form.fields.username')" name="username">
          <Input
            ...
            :placeholder="t('employee.detail.form.placeholder.username')"
          />
        </FormItem>
        ...
        <FormItem :label="t('employee.detail.form.fields.department')" name="departmentId">
          <Cascader
            ...
            :placeholder="t('employee.detail.form.placeholder.department')"
            :options="cascaderOptions"
            v-model:value="selectedDepartmentId"
          />
        </FormItem>
        <FormItem
          :label="t('employee.detail.form.fields.formOfEmployment')"
          name="formOfEmployment"
        >
          <Select
            :placeholder="t('employee.detail.form.placeholder.formOfEmployment')"
          ...
          <Row>
            ...
            <Col>
              <Button type="primary" @click="handleSave" :loading="confirmLoading">
                {{
                  route.params.id
                    ? t('employee.detail.form.buttons.update')
                    : t('employee.detail.form.buttons.save')
                }}
              </Button>
            </Col>
          </Row>
