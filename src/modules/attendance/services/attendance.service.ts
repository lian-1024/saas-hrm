import type { AttendanceAdtStatu, AttendanceList, AttendancePagingParams, CompanyVO, UpdateAttendanceParams, UpdateCompanyParams } from '@/modules/attendance/types';
