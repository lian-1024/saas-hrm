...
import { PermissionTree } from '@utils/convert/permission'
import type { PermissionTableTreeNode } from '@utils/convert/types'
...
<template>
  <Flex class="permission-wrapper h-full" vertical gap="middle">
    <div>
      <Button type="primary" @click="handleAddPermission(0)">{{
    ...
    <PermissionModal
      :permission-id="currentSelectedPermissionId"
      :is-edit="isEdit"
