...
const Result404 = defineComponent({
  ...
  setup() {
    ...
    return () => (
      <Result status="404" title={<ResultTitle title={t('result.404.title')} color={token.value.colorText} />} subTitle={<ResultSubTitle subTitle={t('result.404.subTitle')} color={token.value.colorTextSecondary} />} >
        {{
          extra: () => (
